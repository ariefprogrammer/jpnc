...
<section class="product-detail-section py-2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mt-2" data-aos="fade-right" data-aos-duration="1000">
            ...
            <!-- Product Info & Table -->
            <div class="col-lg-4 mt-2" data-aos="fade-left" data-aos-duration="1000">
                <!-- Product Basic Info -->
                <div class="product-info-card p-4 mb-4" style="height: 403px;">
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-hashtag text-primary me-2" style="min-width: 20px;"></i>
                                    <span><strong>No. 80142</strong></span>
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-calendar-day text-primary me-2" style="min-width: 20px;"></i>
                                    <span>Tanggal dibuat: <strong>19/12/2025</strong></span>
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-sync-alt text-primary me-2" style="min-width: 20px;"></i>
                                    <span>Terakhir diperbarui: <strong>19/12/2025</strong></span>
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-eye text-primary me-2" style="min-width: 20px;"></i>
                                    <span>Jumlah tayangan: <strong>1,374</strong></span>
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-handshake text-primary me-2" style="min-width: 20px;"></i>
                                    <span>Jumlah negosiasi M&A: <strong>41</strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
