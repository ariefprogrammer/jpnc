<?php include 'header.php'; ?>
    ...
    <section id="home" class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <!-- Left Content (50%) -->
                <div class="col-md-6 hero-content-left" data-aos="fade-down-right" data-aos-duration="1000">
                    ...
                    <div class="hero-buttons">
                        ...
                        <a href="inquiry.php" 
                        class="btn btn-whatsapp p-3" target="_blank">
                            <i class="fas fa-envelope me-2"></i> Buat Inquiry
                        </a>
                    </div>
                </div>
                
                <!-- Right Content (50%) - Carousel -->
    ...
    <!-- timelinee Section - FIXED -->
    <section id="timelinee" class="timelinee-section">
        <div class="container">
            <h2 class="section-title-about text-center" data-aos="fade-up" data-aos-duration="1000">Alur Pengajuan</h2>
            <p class="text-center mb-5" data-aos="fade-up" data-aos-duration="1000">Proses step-by-step untuk mendapatkan properti impian Anda dengan mudah dan transparan</p>
            
            <div class="timelinee">
                <!-- Step 1 -->
                <div class="timelinee-step left" data-aos="fade-right" data-aos-duration="1000">
                    <div class="timelinee-content">
                        <div class="step-number">1</div>
                        <h4>Penjajaran Tujuan</h4>
                        <ul>
                            <li>Anggaran</li>
                            <li>Waktu</li>
                            <li>Profil risiko</li>
                            <li>Target imbal hasil</li>
                        </ul>
                    </div>
                </div>
                
                <!-- Step 2 -->
                <div class="timelinee-step right" data-aos="fade-left" data-aos-duration="1000">
                    <div class="timelinee-content">
                        <div class="step-number">2</div>
                        <h4>Pencarian Deal</h4>
                        <ul>
                            <li>Shortlist properti/perusahaan</li>
                            <li>Evaluasi awal</li>
                        </ul>
                    </div>
                </div>
